...
const activities = [
  {
    ...
    desc: "Work alongside mentors on interesting research projects",
  },
  {
    title: "Speaker Series",
    desc: "Hear directly from experts in the field.",
  },
  {
    title: "Debates & Simulations",
    desc: "Participate in bimonthly events to explore AI ethics and decision-making.",
  },
  {
    title: "Newsletter",
    desc: "Stay up to date with the latest news and developments in AI ethics and research.",
  },
  {
    ...
    >
      ...
      <section className="relative flex flex-col items-center justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-xs text-center font-bold text-gray-400 uppercase tracking-widest mb-2">Disclaimer</p>
